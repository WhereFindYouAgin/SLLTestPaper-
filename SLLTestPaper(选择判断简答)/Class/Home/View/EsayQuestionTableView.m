...
@interface EsayQuestionTableView()<UITableViewDataSource, UITableViewDelegate, UITextViewDelegate>
@property (nonatomic,strong) HYTextView *textView;
@property (nonatomic,copy) NSString *uAnswer;

@end

@implementation EsayQuestionTableView
